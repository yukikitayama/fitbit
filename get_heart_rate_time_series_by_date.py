...
RESPONSE_JSON = f'data/heart_rate_time_series_{DATE}.json'
PERIOD = '1d'  # Supported: 1d | 7d | 30d | 1w | 1m
...
def main():
    ...
    url = f'https://api.fitbit.com/1/user/{encoded_id}/activities/heart/date/{DATE}/{PERIOD}.json'
    headers = {
